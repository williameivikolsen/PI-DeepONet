...
to perform better than PI DeepONet 2. Recall that the difference was that PI DeepONet 2 had its labelled training data in the form of angular flux
...
shifts, were the mean of the source distributions are higher, the performance appears to be better, likely because of the higher mean scalar flux.
