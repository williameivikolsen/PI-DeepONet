...
\end{equation}
where $T_{ri}$ and $P_{ri}$ represent the true value and predicted value of the scalar flux $\tilde{\varphi}(x)$ and
$\bar{T}_r$ is the mean of the true scalar flux $\varphi(x)$. The $R^2$ score ranges up to 1, where higher values indicate better predictive accuracy. However, a
